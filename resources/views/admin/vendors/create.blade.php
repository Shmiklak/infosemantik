...
@section('content')
    <section class="content-header">
        <h1>
            Добавление вендора
            <small>Здесь вы можете добавить вендора</small>
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="POST" enctype="multipart/form-data" action="{{route('vendors.store')}}">
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Заголовок</label>
                                <input type="text" class="form-control" id="title" name="title"
                                       placeholder="LG" value="{{ old('title') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="link" name="link"
                                       placeholder="htttps://lg.com" value="{{ old('link') }}">
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-default pull-right" href="{{ route('vendors.index') }}">Назад</a>
                        </div>
                    </form>
                </div>
            </div>
