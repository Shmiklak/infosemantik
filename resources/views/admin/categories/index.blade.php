...
@section('content')
    <section class="content-header">
        <h1>
            Категории продукции
            <small>Здесь вы можете увидеть список всех категорий на сайте</small>
        </h1>
    </section>

    <section class="content container-fluid">
        <div class="categories-container dd">
            <div class="">
...
@push('scripts')
    ...
    <script>
        ...
        function updateCategories() {
            var output = $('.categories-container').nestable('serialize');

            $.ajax({

                type: 'POST',

                url: '/admin/update-categories',
