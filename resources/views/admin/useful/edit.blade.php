        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="POST" enctype="multipart/form-data" action="{{route('useful.update', $post->id)}}">
                        @csrf
                        @method("PUT")
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                       placeholder="Независимые СМИ потому и независимы, что чистый разум не скован границами" value="{{ $post->title }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="upload-preview">
                                <img id="image-preview" style="display:inline-block" src="/{{ $post->image }}"/>
                            </div>
